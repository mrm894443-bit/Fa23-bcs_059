                ...
                FadeTransition(
                  ...
                  child: Text(
                    ...
                    style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                      color: Theme.of(
                        context,
                      ).colorScheme.secondary.withOpacityF(0.8),
                      fontSize: 16,
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          AppTheme.accent.withOpacityF(0.10),
                          AppTheme.neonGreen.withOpacityF(0.05),
                        ],
                      ),
                      borderRadius: BorderRadius.circular(16),
                      border: Border.all(
                        color: AppTheme.accent.withOpacityF(0.5),
                        width: 2,
                      ),
                      boxShadow: [
                        BoxShadow(
                          color: AppTheme.accent.withOpacityF(0.3),
                          blurRadius: 12,
                          spreadRadius: 2,
                        ),
                      ],
