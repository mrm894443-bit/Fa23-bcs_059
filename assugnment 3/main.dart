          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                colors: [
                  const Color(0xFFFFF59D).withOpacityF(0.98),
                  const Color(0xFFFFF59D).withOpacityF(0.5),
                ],
              ),
              boxShadow: [
                BoxShadow(
                  color: const Color(0xFFFFF59D).withOpacityF(0.25),
                  blurRadius: 12,
...
class WeatherApp extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Color scheme: light yellow theme (primary) with cool cyan accent
    const seed = Color(0xFFFFF59D);
    return MaterialApp(
      title: 'Weather App',
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        const Color(0xFFFFF59D).withOpacityF(0.95),
                        const Color(0xFFFFF59D).withOpacityF(0.6),
                      ],
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return TweenAnimationBuilder<double>(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: theme.colorScheme.primary.withOpacityF(0.06),
